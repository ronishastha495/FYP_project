...
from .views import RegisterView, LoginView, PasswordResetView, ChangePasswordView, CheckAuthenticationView, LogoutView, UserProfileView, ServiceManagerProfileView
